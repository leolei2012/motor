...
void LED_Init(void)
{
  ...
  LL_GPIO_SetPinMode(LED_RED_GPIO_PORT, LED_RED_PIN, LL_GPIO_MODE_OUTPUT);
  /* Reset value is LL_GPIO_OUTPUT_PUSHPULL */
  //LL_GPIO_SetPinOutputType(LED_RED_GPIO_PORT, LED_RED_PIN, LL_GPIO_OUTPUT_PUSHPULL);
  /* Reset value is LL_GPIO_SPEED_FREQ_LOW */
  //LL_GPIO_SetPinSpeed(LED_RED_GPIO_PORT, LED_RED_PIN, LL_GPIO_SPEED_FREQ_LOW);
  /* Reset value is LL_GPIO_PULL_NO */
  //LL_GPIO_SetPinPull(LED_RED_GPIO_PORT, LED_RED_PIN, LL_GPIO_PULL_NO);
